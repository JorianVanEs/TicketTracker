...
var _mapComp = __webpack_require__(30);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_mapComp2.default, null),
...
*/
var ba=__webpack_require__(0),m=__webpack_require__(9),A=__webpack_require__(4),C=__webpack_require__(3),ea=__webpack_require__(10),fa=__webpack_require__(11),ha=__webpack_require__(12),ja=__webpack_require__(5);
...
var _filterComp = __webpack_require__(28);

var _filterComp2 = _interopRequireDefault(_filterComp);
...
var Aside = function (_React$Component) {
    ...
    _createClass(Aside, [{
        key: '_logging',
        value: function _logging(string) {
            console.log(string);
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_filterComp2.default, { say: function say(string) {
                        return _this2._logging(string);
                    } })
            );
        }
    }]);
...
var FilterComp = function (_React$Component) {
    _inherits(FilterComp, _React$Component);

    function FilterComp() {
        _classCallCheck(this, FilterComp);

        return _possibleConstructorReturn(this, (FilterComp.__proto__ || Object.getPrototypeOf(FilterComp)).apply(this, arguments));
    }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { onClick: function onClick() {
                                return _this2.props.say("music");
                            } },
                        ' ',
                        _react2.default.createElement('div', { id: 'icon', className: 'music' }),
                        ' ',
                        _react2.default.createElement(
                            'div',
                            { id: 'title' },
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        ' ',
                        _react2.default.createElement('div', { id: 'icon', className: 'film' }),
                        ' ',
                        _react2.default.createElement(
                            'div',
                            { id: 'title' },
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        ' ',
                        _react2.default.createElement('div', { id: 'icon', className: 'art' }),
                        ' ',
                        _react2.default.createElement(
                            'div',
                            { id: 'title' },
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        ' ',
                        _react2.default.createElement('div', { id: 'icon', className: 'misc' }),
                        ' ',
                        _react2.default.createElement(
                            'div',
                            { id: 'title' },
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'p',
                    null,
                    ' Powered by Ticketmaster Discovery API V2 '
                )
            );
        }
    }]);
...
var _GoogleMapsApi = __webpack_require__(31);

var _GoogleMapsApi2 = _interopRequireDefault(_GoogleMapsApi);

var _popUpDetails = __webpack_require__(32);

var _popUpDetails2 = _interopRequireDefault(_popUpDetails);
...
var MapComp = function (_React$Component) {
    ...
    function MapComp() {
        _classCallCheck(this, MapComp);

        var _this = _possibleConstructorReturn(this, (MapComp.__proto__ || Object.getPrototypeOf(MapComp)).call(this));
        ...
        _this.gmapApi = new _GoogleMapsApi2.default();
        _this.gmapApi.load().then(function () {
            _this._fetchData();
        });
        return _this;
    }
    ...
    _createClass(MapComp, [{
        ...
        value: function _fetchData() {
            ...
            var dateTime = today.getFullYear() + "-" + month + "-" + day;

            fetch("https://app.ticketmaster.com/discovery/v2/events.json?&size=200&countryCode=NL" + "&classificationName=music" + "&startDateTime=" + dateTime + "T00:00:00Z" + "&endDateTime=" + dateTime + "T23:59:00Z" + "&apikey=26q7XKcgQmaXqIIBLUfvJnnop7CVEZCL").then(function (response) {
                return response.json();
            }).then(function (json) {
                return _this2._createMap(json, dateTime);
            });
        }
    }, {
        key: '_createMap',
        value: function _createMap(data, start) {
            var _this3 = this;
            ...
            if (data._embedded) {
                var filterStatus = data._embedded.events.filter(function (props) {
                    return props.dates.status.code == "onsale";
                });

                filterStatus.forEach(function (item) {
                    ...
                    marker.addListener('click', function () {
                        _this3.setState({
                            list: _react2.default.createElement(_popUpDetails2.default, { closePopUp: function closePopUp() {
                                    return _this3._closePopUp();
                                }, venueId: item._embedded.venues[0].id, venueName: item._embedded.venues[0].name, eventStart: start })
                        });
                    });
                });
            } else {
...
var GoogleMapsApi = function () {
  function GoogleMapsApi() {
    ...
    this.apiKey = 'AIzaSyAsh1JAlWZL0SBacR3N94aVzrp4PPGQQeg';
...
var PopUpDetails = function (_React$Component) {
    _inherits(PopUpDetails, _React$Component);

    function PopUpDetails(props) {
        _classCallCheck(this, PopUpDetails);

        var _this = _possibleConstructorReturn(this, (PopUpDetails.__proto__ || Object.getPrototypeOf(PopUpDetails)).call(this, props));
    ...
    _createClass(PopUpDetails, [{
        ...
        value: function componentWillMount() {
            ...
            fetch("https://app.ticketmaster.com/discovery/v2/events.json?countryCode=NL&venueId=" + this.props.venueId + "&startDateTime=" + this.props.eventStart + "T00:00:00Z" + "&endDateTime=" + this.props.eventStart + "T23:59:00Z" + "&apikey=26q7XKcgQmaXqIIBLUfvJnnop7CVEZCL").then(function (response) {
                return response.json();
            }).then(function (json) {
                return _this2._createComponentArray(json._embedded.events);
            });
        }
    }, {
        key: '_createComponentArray',
        value: function _createComponentArray(data) {
            var filterStatus = data.filter(function (props) {
                return props.dates.status.code == "onsale";
            });
            ...
            filterStatus.forEach(function (item) {
                ...
                componentArray.push(_react2.default.createElement(_listItem2.default, {
                    key: item.id,
                    eventName: item.name,
                    eventImg: item.images.find(function (obj) {
                        return obj.ratio == "4_3";
                    }).url,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { id: 'close', onClick: function onClick() {
...
var ListItem = function (_React$Component) {
    ...
    function ListItem(props) {
        ...
        _this.date = new Date(_this.props.eventDateTime);

        _this.type = _this.props.eventType;

        if (_this.type == "Arts & Theatre") {
            _this.type = "Arts";
        }
        return _this;
    }
    ...
    _createClass(ListItem, [{
        ...
        value: function componentWillMount() {
            ...
            var time = weekdays[this.date.getDay()] + ", " + this.date.getHours() + ":" + this.date.getMinutes();
        ...
        value: function render() {
            return _react2.default.createElement(
                'li',
                null,
                _react2.default.createElement('img', { src: this.props.eventImg }),
                this.state.date,
                _react2.default.createElement(
                    'div',
                    { id: 'details' },
                ...
                _react2.default.createElement(
                    'div',
                    { id: 'control' },
                    _react2.default.createElement('div', { id: 'genre', className: this.type }),
                    _react2.default.createElement(
                        'a',
